...
- [III. Pencahayaan dalam Hidroponik NFT Vertikal](#iii-pencahayaan-dalam-hidroponik-nft-vertikal)
  ...
  - [Contoh Lampu LED untuk Indoor](#contoh-lampu-led-untuk-indoor)
  - [1. **Lampu LED Full Spectrum (Cahaya Merah, Biru, dan Putih)**](#1-lampu-led-full-spectrum-cahaya-merah-biru-dan-putih)
    - [Contoh Produk:](#contoh-produk)
  - [2. **Lampu LED Grow Strip (Flexible)**](#2-lampu-led-grow-strip-flexible)
    - [Contoh Produk:](#contoh-produk-1)
  - [3. **LED COB Grow Lights**](#3-led-cob-grow-lights)
    - [Contoh Produk:](#contoh-produk-2)
  - [Gambar LED Grow Light yang Umum di Pasaran](#gambar-led-grow-light-yang-umum-di-pasaran)
...
![hidroponik-indoor-with-led](/static/images/hidroponik/hidroponik-indoor-with-led.webp)
...
$$
20.000 \, \text{lux} \times 4,71 \, \text{m2} = 94.200 \, \text{lumens}
$$
...
#### Contoh Lampu LED untuk Indoor

Untuk sistem hidroponik indoor NFT vertikal, pemilihan lampu LED yang tepat sangat penting agar tanaman tumbuh optimal. Berikut adalah beberapa pilihan lampu LED yang umum di pasaran dan cocok digunakan untuk kebutuhan hidroponik:

#### 1. **Lampu LED Full Spectrum (Cahaya Merah, Biru, dan Putih)**

Lampu LED full spectrum dirancang khusus untuk pertanian indoor, memberikan kombinasi spektrum cahaya merah, biru, dan putih yang mendukung semua tahap pertumbuhan tanaman, dari vegetatif hingga berbunga. Produk ini biasanya memiliki fitur daya tahan tinggi dan efisiensi energi.

##### Contoh Produk:

- **VIPARSPECTRA LED Grow Light** (300W/600W/1000W)

  - Fitur: Spektrum penuh dengan dominasi cahaya merah (60%) dan biru (30%), ideal untuk berbagai fase pertumbuhan.
  - Umur lampu: 50.000 jam.
  - Efisiensi energi yang tinggi dengan distribusi cahaya yang merata.

- **Mars Hydro TS Series LED** (1000W)
  - Fitur: Spektrum penuh dengan distribusi intens cahaya merah dan biru, serta penambahan inframerah (IR) dan ultraviolet (UV) untuk merangsang pertumbuhan tambahan.
  - Desain tanpa kipas sehingga lebih senyap dan hemat energi.

#### 2. **Lampu LED Grow Strip (Flexible)**

Grow strip adalah lampu LED fleksibel yang dapat diatur dan ditempatkan di berbagai bagian sistem menara vertikal, sehingga memungkinkan distribusi cahaya yang lebih merata di antara tingkat menara.

##### Contoh Produk:

- **Monios-L T5 LED Grow Light Strip**
  - Fitur: Didesain ramping dan fleksibel dengan spektrum penuh (merah, biru, dan putih).
  - Instalasi mudah dengan menggunakan bracket atau tali gantung.
  - Ideal untuk penempatan di sisi menara.

#### 3. **LED COB Grow Lights**

Lampu LED COB (Chip on Board) menggabungkan banyak chip LED dalam satu modul, memberikan intensitas cahaya yang lebih tinggi dengan distribusi spektrum yang merata. Jenis lampu ini cocok untuk sistem menara vertikal yang memerlukan pencahayaan intens pada beberapa tingkat.

##### Contoh Produk:

- **Roleadro COB LED Grow Light** (600W)
  - Fitur: Menggunakan teknologi COB yang lebih efisien dengan output cahaya yang lebih tinggi.
  - Spektrum penuh dengan tambahan UV dan IR.
  - Pendinginan yang baik dengan sistem heat sink bawaan.

---

#### Gambar LED Grow Light yang Umum di Pasaran

Berikut adalah contoh gambar dari **VIPARSPECTRA LED Grow Light** dan **Monios-L T5 LED Grow Light Strip** yang bisa digunakan:

![VIPARSPECTRA LED Grow Light](https://example.com/viparspectra_led_grow_light.png)
_Gambar VIPARSPECTRA LED Grow Light (1000W)_

![Monios-L T5 LED Grow Light Strip](https://example.com/monios_t5_led_grow_light_strip.png)
_Gambar Monios-L T5 LED Grow Light Strip_

> **Catatan**: Pastikan untuk memilih lampu yang sesuai dengan ukuran dan kebutuhan ruangan hidroponik Anda. Lampu full spectrum adalah pilihan terbaik karena mereka mampu meniru sinar matahari alami dan cocok untuk semua fase pertumbuhan tanaman.

#### Rekomendasi Penggunaan:

1. **VIPARSPECTRA LED Grow Light**:

   - Cocok dipasang di atas menara vertikal, dengan beberapa unit untuk menutupi seluruh area sistem.
   - Setiap unit 600W bisa mencakup area sekitar 1 m², sehingga untuk 5 menara yang mencakup sekitar 4,71 m², diperlukan sekitar 4–5 unit lampu ini.

2. **Monios-L T5 LED Grow Light Strip**:
   - Cocok ditempatkan di sisi menara untuk memberikan pencahayaan tambahan pada tanaman di bagian bawah yang mungkin kurang mendapatkan sinar dari lampu utama di atas.

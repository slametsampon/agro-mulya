...
- [**7. Sistem Degassing \& Oksigenasi dalam RAS (Recirculating Aquaculture System)**](#7-sistem-degassing--oksigenasi-dalam-ras-recirculating-aquaculture-system)
  ...
  - [**Apakah Sistem Degassing \& Oksigenasi Masih Diperlukan dalam Aquaponik?**](#apakah-sistem-degassing--oksigenasi-masih-diperlukan-dalam-aquaponik)
    - [**1. Sistem Degassing dalam Aquaponik**](#1-sistem-degassing-dalam-aquaponik)
    - [**2. Sistem Oksigenasi dalam Aquaponik**](#2-sistem-oksigenasi-dalam-aquaponik)
  - [**Rancangan Degassing**](#rancangan-degassing)
    - [**Komponen Sistem Degassing**](#komponen-sistem-degassing)
    - [**Langkah-Langkah Merancang Sistem Degassing**](#langkah-langkah-merancang-sistem-degassing)
      - [1. **Menentukan Gas yang Perlu Dihilangkan**](#1-menentukan-gas-yang-perlu-dihilangkan)
      - [2. **Menentukan Ukuran Sistem Degassing**](#2-menentukan-ukuran-sistem-degassing)
      - [3. **Desain Degassing Tower**](#3-desain-degassing-tower)
      - [4. **Ventilasi Udara**](#4-ventilasi-udara)
      - [5. **Sistem Aerasi Tambahan**](#5-sistem-aerasi-tambahan)
      - [6. **Pemantauan dan Pengujian**](#6-pemantauan-dan-pengujian)
    - [**Contoh Desain Degassing Tower**](#contoh-desain-degassing-tower)
      - [**Sketsa Desain:**](#sketsa-desain)
- [**8. Hidroponik Vertikal dalam Aquaponik**](#8-hidroponik-vertikal-dalam-aquaponik)
  ...
  - [**Apakah Ini Sudah Cukup?**](#apakah-ini-sudah-cukup)
    - [1. **Kepadatan Ikan dalam Sistem**:](#1-kepadatan-ikan-dalam-sistem)
    - [2. **Jenis Ikan dan Biofilter**:](#2-jenis-ikan-dan-biofilter)
    - [3. **Pemantauan Kadar CO₂ dan Oksigen**:](#3-pemantauan-kadar-co-dan-oksigen)
    - [4. **Waktu dan Kondisi Operasional**:](#4-waktu-dan-kondisi-operasional)
    - [5. **Tingkat Aliran Air**:](#5-tingkat-aliran-air)
...
- [**9. Analisis Ekonomi untuk Sistem Aquaponik Pemula**](#9-analisis-ekonomi-untuk-sistem-aquaponik-pemula)
  ...
  - [**4. Analisis Laba Rugi dan Break-Even Point (BEP)**](#4-analisis-laba-rugi-dan-break-even-point-bep)
    - [**Perhitungan Laba/Rugi** (6 bulan):](#perhitungan-labarugi-6-bulan)
    - [**Perhitungan BEP (Break-Even Point)**:](#perhitungan-bep-break-even-point)
...
![Swirl-filter-konsep](/static/images/ras/Swirl-filter-konsep.webp)

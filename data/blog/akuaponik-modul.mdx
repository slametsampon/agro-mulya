...
- [**Pendahuluan**](#pendahuluan)
  ...
  - [**Kutipan Analisis Ekonomi untuk Menarik Pembaca**](#kutipan-analisis-ekonomi-untuk-menarik-pembaca)
- [**Bab 1: Rancangan Umum Sistem**](#bab-1-rancangan-umum-sistem)
  - [**1. Desain Kolam Ikan**](#1-desain-kolam-ikan)
    - [**Kriteria Rancangan Kolam Ikan:**](#kriteria-rancangan-kolam-ikan)
  - [**2. Sistem Hidroponik di Atas Kolam**](#2-sistem-hidroponik-di-atas-kolam)
    - [**Kriteria Rancangan Sistem Hidroponik:**](#kriteria-rancangan-sistem-hidroponik)
- [**Bab 2: Sistem Biofilter**](#bab-2-sistem-biofilter)
  - [1. **Tujuan Biofilter**](#1-tujuan-biofilter)
  - [2. **Data Sistem yang Diketahui**](#2-data-sistem-yang-diketahui)
  - [3. **Menghitung Kebutuhan Biofilter**](#3-menghitung-kebutuhan-biofilter)
    - [a. **Menghitung Luas Permukaan Media Biofilter yang Dibutuhkan**](#a-menghitung-luas-permukaan-media-biofilter-yang-dibutuhkan)
    - [b. **Menghitung Volume Media Bio Ball**](#b-menghitung-volume-media-bio-ball)
  - [4. **Desain Biofilter**](#4-desain-biofilter)
    - [a. **Tangki/Wadah Biofilter**](#a-tangkiwadah-biofilter)
    - [b. **Sistem Aliran Air**](#b-sistem-aliran-air)
    - [c. **Aerasi Biofilter**](#c-aerasi-biofilter)
    - [d. **Perhitungan Aliran Air**](#d-perhitungan-aliran-air)
  - [5. **Pengelolaan dan Pemeliharaan Biofilter**](#5-pengelolaan-dan-pemeliharaan-biofilter)
  - [**Gambar Rancangan Biofilter (Deskripsi)**](#gambar-rancangan-biofilter-deskripsi)
  - [**Kesimpulan**](#kesimpulan)
  - [**Rekomendasi bioball**](#rekomendasi-bioball)
    - [1. **Jebao Bio Ball**](#1-jebao-bio-ball)
    - [2. **AquaKing Bio Ball**](#2-aquaking-bio-ball)
    - [3. **PondPro Bio Ball**](#3-pondpro-bio-ball)
    - [4. **Eheim Bio Ball**](#4-eheim-bio-ball)
    - [5. **Boyu Bio Ball**](#5-boyu-bio-ball)
    - [**Faktor yang Perlu Dipertimbangkan Saat Memilih Bio Ball:**](#faktor-yang-perlu-dipertimbangkan-saat-memilih-bio-ball)
    - [**Rekomendasi Akhir:**](#rekomendasi-akhir)
- [**Bab 3: Filter Mekanis dengan ICP**](#bab-3-filter-mekanis-dengan-icp)
  - [**Apa itu Inclined Clarifier Plate (ICP)?**](#apa-itu-inclined-clarifier-plate-icp)
  - [**Bagaimana ICP Bekerja?**](#bagaimana-icp-bekerja)
  - [**Apakah ICP Cocok untuk Sistem Aquaponik?**](#apakah-icp-cocok-untuk-sistem-aquaponik)
  - [**Rancangan ICP untuk Sistem Aquaponik Anda**](#rancangan-icp-untuk-sistem-aquaponik-anda)
    - [**Komponen Dasar ICP**](#komponen-dasar-icp)
  - [**Keuntungan ICP dalam Sistem Aquaponik**](#keuntungan-icp-dalam-sistem-aquaponik)
  - [**Rancangan ICP**](#rancangan-icp)
    - [1. **Tujuan ICP dalam Sistem Aquaponik**](#1-tujuan-icp-dalam-sistem-aquaponik)
    - [2. **Dimensi Tangki ICP**](#2-dimensi-tangki-icp)
    - [3. **Spesifikasi Pelat**](#3-spesifikasi-pelat)
    - [4. **Aliran Air dan Laju Aliran (Q)**](#4-aliran-air-dan-laju-aliran-q)
    - [5. **Komponen Utama Desain ICP**](#5-komponen-utama-desain-icp)
      - [a. **Inlet Air**](#a-inlet-air)
      - [b. **Pelat Miring**](#b-pelat-miring)
      - [c. **Pembuangan Kotoran**](#c-pembuangan-kotoran)
      - [d. **Outlet Air**](#d-outlet-air)
      - [e. **Tangki dan Pelat Material**](#e-tangki-dan-pelat-material)
    - [6. **Keunggulan Rancangan ICP**](#6-keunggulan-rancangan-icp)
      - [**Diagram Desain ICP (Deskripsi)**](#diagram-desain-icp-deskripsi)
    - [7. **Estimasi Pemeliharaan dan Operasi**](#7-estimasi-pemeliharaan-dan-operasi)
...
- [**Bab 7: Rincian Hitungan Daya dan Implementasi Panel Surya**](#bab-7-rincian-hitungan-daya-dan-implementasi-panel-surya)
  - [**1. Rincian Hitungan Power (Menggunakan Airlift Pump untuk Kolam dan ICP ke Biofilter)**](#1-rincian-hitungan-power-menggunakan-airlift-pump-untuk-kolam-dan-icp-ke-biofilter)
    - [**Kebutuhan Daya Total**](#kebutuhan-daya-total)
      - [**Airlift Pump: Kolam ke ICP dan ICP ke Biofilter**](#airlift-pump-kolam-ke-icp-dan-icp-ke-biofilter)
      - [**Estimasi Daya untuk Airlift Pump**](#estimasi-daya-untuk-airlift-pump)
    - [**Hitungan Pompa dan Blower DC**](#hitungan-pompa-dan-blower-dc)
      - [**Pompa DC untuk Modul Hidroponik Vertikal**](#pompa-dc-untuk-modul-hidroponik-vertikal)
      - [**Blower DC untuk Kolam dan Biofilter**](#blower-dc-untuk-kolam-dan-biofilter)
      - [**Efisiensi Energi Tanpa Inverter**](#efisiensi-energi-tanpa-inverter)
    - [**Kesimpulan dari Rincian Hitungan Power**](#kesimpulan-dari-rincian-hitungan-power)
      - [**Catatan:**](#catatan)
  - [**2. Hitungan Sistem Panel Surya DC (Tanpa Inverter)**](#2-hitungan-sistem-panel-surya-dc-tanpa-inverter)
    - [**Total Konsumsi Daya Harian**](#total-konsumsi-daya-harian)
    - [**Perhitungan Kapasitas Panel Surya**](#perhitungan-kapasitas-panel-surya)
    - [**Perhitungan Kapasitas Baterai**](#perhitungan-kapasitas-baterai)
    - [**Pengaturan dengan Charge Controller**](#pengaturan-dengan-charge-controller)
  - [**3. Keuntungan Penggunaan DC Tanpa Inverter**](#3-keuntungan-penggunaan-dc-tanpa-inverter)
    - [**Efisiensi Energi Lebih Tinggi**](#efisiensi-energi-lebih-tinggi)
    - [**Biaya Lebih Rendah**](#biaya-lebih-rendah)
...
#### **Kutipan Analisis Ekonomi untuk Menarik Pembaca**
